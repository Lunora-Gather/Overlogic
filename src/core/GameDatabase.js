...
class GameDatabaseClass {
  ...
  async loadAll() {
    ...
    const [c, a, e, b, r] = await Promise.all([
      fetch('data/conditions.json?v=20260725-4').then(r => r.json()),
      fetch('data/actions.json?v=20260725-4').then(r => r.json()),
      fetch('data/enemies.json?v=20260725-4').then(r => r.json()),
      fetch('data/battles.json?v=20260725-4').then(r => r.json()),
      fetch('data/rewards.json?v=20260725-4').then(r => r.json()),
    ]);
